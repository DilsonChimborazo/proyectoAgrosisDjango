...
// 🌐 WebSocket Servers
const char* websocket_mediciones = "ws://10.4.24.120:8000/ws/api/mide/";
const char* websocket_sensores = "ws://10.4.24.120:8000/ws/api/sensores/";
...
void loop() {
  ...
  // Mostrar datos en OLED (usando datos locales para consistencia)
  ...
  doc["nombre_sensor"] = "Sensor de temperatura";
  doc["fecha_medicion"] = fechaHora;
  ...
  doc["nombre_sensor"] = "Sensor de viento";
  serializeJson(doc, jsonData);
  client_mediciones.send(jsonData);
  Serial.print("📡 Datos enviados por WebSocket: ");
  Serial.println(jsonData);
  ...
  doc["nombre_sensor"] = "Sensor de luz";
  serializeJson(doc, jsonData);
  client_mediciones.send(jsonData);
  Serial.print("📡 Datos enviados por WebSocket: ");
  Serial.println(jsonData);
  ...
  doc["nombre_sensor"] = "Sensor de humedad";
  serializeJson(doc, jsonData);
  client_mediciones.send(jsonData);
  Serial.print("📡 Datos enviados por WebSocket: ");
  Serial.println(jsonData);
