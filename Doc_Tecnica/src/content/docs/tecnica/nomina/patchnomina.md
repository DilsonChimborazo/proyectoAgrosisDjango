---
title: Actualizar Nómina por Campo Específico  
description: Actualiza campos específicos de un registro de nómina existente en el sistema.
---
## Descripción:
Solicitud utilizada para actualizar uno o más campos específicos de un registro de nómina existente en el sistema.
...
### **Endpoint**
```
http://127.0.0.1:8000/api/tecnica/nomina/patchnomina/<id>/
```
...
📄 **Nota:** Solo los administradores pueden actualizar campos específicos de nóminas en el sistema.
