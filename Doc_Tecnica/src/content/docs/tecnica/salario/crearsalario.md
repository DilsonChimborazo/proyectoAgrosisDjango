---
title: Crear Salario  
description: Registra un nuevo salario en el sistema.
---
## Descripción:
Solicitud utilizada para el registro de nuevos salarios en el sistema.
...
### **Endpoint**
```
http://127.0.0.1:8000/api/tecnica/salario/crearsalario/
```
...
- **201**: Salario creado con éxito, devuelve el array del salario registrado.
- **400**: Datos incorrectos o faltantes.
- **500**: Error del servidor.

---

📄 **Nota:** Solo los administradores pueden crear salarios en el sistema.
