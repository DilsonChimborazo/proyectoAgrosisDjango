...
description: Actualiza un registro de movimiento de stock existente en el sistema.
---
## Descripción:
Solicitud utilizada para actualizar un registro de movimiento de stock (entrada o salida) existente en el sistema.
...
### **Endpoint**
```
http://127.0.0.1:8000/api/tecnica/stock/actualizarstock/<id>/
```
...
```json
{
    ...
    "fk_id_item_venta": null,
    "cantidad": "120.750",
    "fecha": "2025-06-11T17:56:00-05:00",
    "movimiento": "Entrada"
}
```
...
---
📄 **Nota:** Solo los administradores pueden actualizar movimientos de stock en el sistema.
---