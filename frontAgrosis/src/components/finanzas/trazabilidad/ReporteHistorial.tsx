...
const ReporteHistorial = ({ ordenarSnapshots, formato }: ReporteHistorialProps) => {
  ...
  const generarReporte = async () => {
    ...
    if (formato === 'pdf') {
      ...
      doc.text('Historial de Snapshots', leftMargin, infoY, { align: 'left' });
      doc.setFontSize(10);
    ...
    <div className="space-y-6 p-4 bg-white rounded-lg shadow-sm">
      ...
      <div ref={chartRef}>
        <ChartLine
          ...
          options={{
            plugins: { title: { display: true, text: 'Evolución de Relación B/C', font: { size: 16 } } },
            scales: {
              y: { beginAtZero: true, title: { display: true, text: 'Relación B/C' } },
            },
          }}
          height={300}
        />
