...
// Importación corregida: se elimina { generarPDF } que causaba el error.
...
// Se añaden las importaciones necesarias para generar el PDF de forma local.
...
  };
    ...
    // --- INICIO DE LÓGICA DE PDF REPLICADA DENTRO DEL COMPONENTE ---
    ...
    // --- FIN DE LÓGICA DE PDF REPLICADA ---
...
    ];
    ...
    // Se llama a la función local que acabamos de replicar.
